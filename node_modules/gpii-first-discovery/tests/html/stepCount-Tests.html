...
<html>
    <head>
        ...
        <title>Step Count Message Display Tests</title>
        ...
        <script src="../js/stepCountTests.js"></script>
    </head>

    <body id="body">
        <h1 id="qunit-header">Step Count Message Display Tests</h1>
        ...
        <!-- Test HTML -->
        <span id="gpiic-tests-stepCountMsg"></span>
    </body>
</html>
