...
<html>
    <head>
        ...
        <script src="../js/helpButtonTests.js"></script>
    </head>

    <body id="body">
        <h1 id="qunit-header">helpButton Tests</h1>
        ...
        <!-- Test control -->
        <button id="gpiic-tests-helpButton">CONTENT BEFORE</button>
    </body>
</html>
