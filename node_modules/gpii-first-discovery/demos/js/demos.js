...
(function ($, fluid) {
    ...
    /**
     * Initialize the preview pane settings
     */
    demo.initWithPreview = function (container, options) {
    	var opts = {
    			gradeNames: ["fluid.prefs.transformDefaultPanelsOptions", "demo.firstDiscovery.init"],
                preview: {
                	options: {
                    	templateUrl: ""
                	}
    	...
    	fluid.prefs.preview(container, $.extend(true, {}, opts, options));
    }
