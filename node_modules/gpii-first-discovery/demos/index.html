...
<html lang="en">
    ...
    <body>
        ...
        <div id="gpiic-fd" style="margin-left: 10%; width: 607px; display: block" class="left gpii-fd slide nowrap">
		   ...
		   <div class="left" style="width:600px;">
	            <section class="row gpii-fd-topButtons">
	                ...
	                <button class="gpiic-fd-help right gpii-fd-help" ></button>
	            </section>
	       ...
	       <div class="left" style="margin-left: 10px; ">     
				<form id="options" class="fl-prefsEditor fl-prefsEditor-fullPreview fl-focus left">
        ...
        <script type="text/javascript">
            demo.firstDiscovery.init("#gpiic-fd", "gpii.firstDiscovery.auxSchema", "demo-firstDiscovery");
        </script>
    </body>
</html>
