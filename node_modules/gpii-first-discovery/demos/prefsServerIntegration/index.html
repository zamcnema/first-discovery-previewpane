...
<html lang="en">
    <head>
        ...
        <script>
           ...
           */
            ...
            /*
            * display and allow toggling of the previewpane. 
            */
            $(document).ready(function() {
    ...
    <body>
        <div id="gpiic-fd" style="margin-left: 10%; width:17em;" class="gpii-fd slide">
            ...
            <nav class="gpiic-fd-nav gpii-fd-nav">
                <div class="gpiic-fd-navButtons gpii-fd-navButtons">
                    ...
                    <button id="gpiic-fd-navButtons-preview" class="gpiic-fd-tooltip left gpii-fd-navButtons-preview">
                        <span class="left gpii-fd-icon"></span>
                        <span class="gpiic-fd-navButtons-previewLabel preview">PREVIEW</span>
                    </button>
