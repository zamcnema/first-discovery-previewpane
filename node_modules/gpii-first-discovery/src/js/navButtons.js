...
(function ($, fluid) {
    ...
    /*
     * The back, preview and next navigation buttons
     */
    fluid.defaults("gpii.firstDiscovery.navButtons", {
        ...
        selectors: {
            ...
            preview: "#gpiic-fd-navButtons-preview",
            previewLabel: ".gpiic-fd-navButtons-previewLabel",
        ...
        listeners: {
            ...
            "onCreate.togglePreviewButtonStates": {
                listener: "{that}.toggleButtonStates",
                args: ["{that}.dom.preview"]
            },
    ...
    /* toggleButtonStates(element, disabled, showSelector)
     * 	- allows you to disable and show a specific button in the nav on specific panels.
     * Input: element - element/button to be targeted. required
     * Input: disabled - which panel it should be disabled on. optional
     * Input: showSelector - specific panel that you would like the normally disabled element to be shown on.
     * @edit: zamcnema@12/30/2015 - very ambiguous, a description would have helped.
     */
