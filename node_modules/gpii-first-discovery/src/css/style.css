...
/* controls */
/* to try to keep the +/- buttons centered in the page,
...
/* Navigation section at bottom, containing back/next/preview and icons */
.gpii-fd-navButtons {
    color: #425165; /* blue-grey */
    background-color: #ffffff;
}

.gpii-fd-navButtons-back, .gpii-fd-navButtons-next, .gpii-fd-navButtons-preview {
    border-radius: 0.5rem;
    visibility: hidden;
    background-color: #425165; /* blue-grey */
    color: #ffffff;
...
.gpii-fd-navButtons-preview:hover,
...
.gpii-fd-navButtons-preview:focus,
...
.gpii-fd-navButtons-preview .gpii-fd-icon:after,
.gpii-fd-navButtons-next .gpii-fd-icon:after {
    position: relative;
    font-size: 4rem;
}

.gpii-fd-navButtons-preview .pgii-fd-icon:before {
	content: "\e606";
}
...
.fl-theme-wb .gpii-fd-navButtons-preview,
...
.fl-theme-wb .gpii-fd-navButtons-preview:hover,
...
.fl-theme-wb .gpii-fd-navButtons-preview:focus,
...
.fl-theme-bw .gpii-fd-navButtons-preview,
...
.fl-theme-bw .gpii-fd-navButtons-preview:hover,
...
.fl-theme-bw .gpii-fd-navButtons-preview:focus,
