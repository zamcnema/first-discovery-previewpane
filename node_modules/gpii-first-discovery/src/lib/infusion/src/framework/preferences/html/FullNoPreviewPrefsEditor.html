<form id="options" class="fl-prefsEditor fl-prefsEditor-fullNoPreview fl-focus">
    <div class="flc-prefsEditor-controls fl-prefsEditors-controls">
        <div class="fl-prefsEditor-category">
            <h2 class="fl-force-left fl-prefsEditor-text-icon">Text and display</h2>
        ...
        <div class="fl-prefsEditor-category">
            <h2 class="fl-force-left fl-prefsEditor-layout-icon">Layout and navigation</h2>
            <div class="flc-prefsEditor-layout-controls fl-prefsEditor-layout"></div>
        </div>

        <div class="fl-prefsEditor-category">
            <h2 class="fl-force-left fl-prefsEditor-links-icon">Links and buttons</h2>
