...
* To view and modify this theme, visit http://jqueryui.com/themeroller/?ffDefault=Verdana%2CArial%2Csans-serif&fwDefault=normal&fsDefault=1.2em&cornerRadius=5px&bgColorHeader=666666&bgTextureHeader=glass&bgImgOpacityHeader=75&borderColorHeader=666666&fcHeader=ffffff&iconColorHeader=ffffff&bgColorContent=ebebeb&bgTextureContent=flat&bgImgOpacityContent=0&borderColorContent=999999&fcContent=000000&iconColorContent=000000&bgColorDefault=ebebeb&bgTextureDefault=inset_hard&bgImgOpacityDefault=100&borderColorDefault=cccccc&fcDefault=666666&iconColorDefault=666666&bgColorHover=999999&bgTextureHover=highlight_soft&bgImgOpacityHover=75&borderColorHover=999999&fcHover=ebebeb&iconColorHover=ebebeb&bgColorActive=ebebeb&bgTextureActive=highlight_hard&bgImgOpacityActive=100&borderColorActive=cccccc&fcActive=000000&iconColorActive=000000&bgColorHighlight=ffffff&bgTextureHighlight=flat&bgImgOpacityHighlight=0&borderColorHighlight=cccccc&fcHighlight=666666&iconColorHighlight=666666&bgColorError=666666&bgTextureError=flat&bgImgOpacityError=0&borderColorError=000000&fcError=ffffff&iconColorError=ffffff&bgColorOverlay=cccccc&bgTextureOverlay=flat&bgImgOpacityOverlay=0&opacityOverlay=50&bgColorShadow=999999&bgTextureShadow=flat&bgImgOpacityShadow=0&opacityShadow=50&thicknessShadow=5px&offsetTopShadow=-5px&offsetLeftShadow=-5px&cornerRadiusShadow=5px&ctl=themeroller
...
----------------------------------*/
.fl-theme-slate .ui-widget {
	font-family: Verdana,Arial,sans-serif;
	font-size: 1.2em;
}
.fl-theme-slate .ui-widget .ui-widget {
	font-size: 1em;
}
.fl-theme-slate .ui-widget input,
.fl-theme-slate .ui-widget select,
.fl-theme-slate .ui-widget textarea,
.fl-theme-slate .ui-widget button {
	font-family: Verdana,Arial,sans-serif;
	font-size: 1em;
}
.fl-theme-slate .ui-widget-content {
	border: 1px solid #999999;
	background: #ebebeb url(images/ui-bg_flat_0_ebebeb_40x100.png) 50% 50% repeat-x;
	color: #000000;
}
.fl-theme-slate .ui-widget-content a {
	color: #000000;
}
.fl-theme-slate .ui-widget-header {
	border: 1px solid #666666;
	background: #666666 url(images/ui-bg_glass_75_666666_1x400.png) 50% 50% repeat-x;
	color: #ffffff;
	font-weight: bold;
}
.fl-theme-slate .ui-widget-header a {
	color: #ffffff;
}

/* Interaction states
----------------------------------*/
.fl-theme-slate .ui-state-default,
.fl-theme-slate .ui-widget-content .ui-state-default,
.fl-theme-slate .ui-widget-header .ui-state-default {
	border: 1px solid #cccccc;
	background: #ebebeb url(images/ui-bg_inset-hard_100_ebebeb_1x100.png) 50% 50% repeat-x;
	font-weight: normal;
	color: #666666;
}
.fl-theme-slate .ui-state-default a,
.fl-theme-slate .ui-state-default a:link,
.fl-theme-slate .ui-state-default a:visited {
	color: #666666;
	text-decoration: none;
}
.fl-theme-slate .ui-state-hover,
.fl-theme-slate .ui-widget-content .ui-state-hover,
.fl-theme-slate .ui-widget-header .ui-state-hover,
.fl-theme-slate .ui-state-focus,
.fl-theme-slate .ui-widget-content .ui-state-focus,
.fl-theme-slate .ui-widget-header .ui-state-focus {
	border: 1px solid #999999;
	background: #999999 url(images/ui-bg_highlight-soft_75_999999_1x100.png) 50% 50% repeat-x;
	font-weight: normal;
	color: #ebebeb;
}
.fl-theme-slate .ui-state-hover a,
.fl-theme-slate .ui-state-hover a:hover,
.fl-theme-slate .ui-state-hover a:link,
.fl-theme-slate .ui-state-hover a:visited {
	color: #ebebeb;
	text-decoration: none;
}
.fl-theme-slate .ui-state-active,
.fl-theme-slate .ui-widget-content .ui-state-active,
.fl-theme-slate .ui-widget-header .ui-state-active {
	border: 1px solid #cccccc;
	background: #ebebeb url(images/ui-bg_highlight-hard_100_ebebeb_1x100.png) 50% 50% repeat-x;
	font-weight: normal;
	color: #000000;
}
.fl-theme-slate .ui-state-active a,
.fl-theme-slate .ui-state-active a:link,
.fl-theme-slate .ui-state-active a:visited {
	color: #000000;
	text-decoration: none;
}
...
/* Interaction Cues
----------------------------------*/
.fl-theme-slate .ui-state-highlight,
.fl-theme-slate .ui-widget-content .ui-state-highlight,
.fl-theme-slate .ui-widget-header .ui-state-highlight {
	border: 1px solid #cccccc;
	background: #ffffff url(images/ui-bg_flat_0_ffffff_40x100.png) 50% 50% repeat-x;
	color: #666666;
}
.fl-theme-slate .ui-state-highlight a,
.fl-theme-slate .ui-widget-content .ui-state-highlight a,
.fl-theme-slate .ui-widget-header .ui-state-highlight a {
	color: #666666;
}
.fl-theme-slate .ui-state-error,
.fl-theme-slate .ui-widget-content .ui-state-error,
.fl-theme-slate .ui-widget-header .ui-state-error {
	border: 1px solid #000000;
	background: #666666 url(images/ui-bg_flat_0_666666_40x100.png) 50% 50% repeat-x;
	color: #ffffff;
}
.fl-theme-slate .ui-state-error a,
.fl-theme-slate .ui-widget-content .ui-state-error a,
.fl-theme-slate .ui-widget-header .ui-state-error a {
	color: #ffffff;
}
.fl-theme-slate .ui-state-error-text,
.fl-theme-slate .ui-widget-content .ui-state-error-text,
.fl-theme-slate .ui-widget-header .ui-state-error-text {
	color: #ffffff;
}
.fl-theme-slate .ui-priority-primary,
.fl-theme-slate .ui-widget-content .ui-priority-primary,
.fl-theme-slate .ui-widget-header .ui-priority-primary {
	font-weight: bold;
}
.fl-theme-slate .ui-priority-secondary,
.fl-theme-slate .ui-widget-content .ui-priority-secondary,
.fl-theme-slate .ui-widget-header .ui-priority-secondary {
	opacity: .7;
	filter:Alpha(Opacity=70);
	font-weight: normal;
}
.fl-theme-slate .ui-state-disabled,
.fl-theme-slate .ui-widget-content .ui-state-disabled,
.fl-theme-slate .ui-widget-header .ui-state-disabled {
	opacity: .35;
	filter:Alpha(Opacity=35);
	background-image: none;
}
.fl-theme-slate .ui-state-disabled .ui-icon {
...
/* states and images */
.fl-theme-slate .ui-icon {
	width: 16px;
	height: 16px;
}
.fl-theme-slate .ui-icon,
.fl-theme-slate .ui-widget-content .ui-icon {
	background-image: url(images/ui-icons_000000_256x240.png);
}
.fl-theme-slate .ui-widget-header .ui-icon {
	background-image: url(images/ui-icons_ffffff_256x240.png);
}
.fl-theme-slate .ui-state-default .ui-icon {
	background-image: url(images/ui-icons_666666_256x240.png);
}
.fl-theme-slate .ui-state-hover .ui-icon,
.fl-theme-slate .ui-state-focus .ui-icon {
	background-image: url(images/ui-icons_ebebeb_256x240.png);
}
.fl-theme-slate .ui-state-active .ui-icon {
	background-image: url(images/ui-icons_000000_256x240.png);
}
.fl-theme-slate .ui-state-highlight .ui-icon {
	background-image: url(images/ui-icons_666666_256x240.png);
}
.fl-theme-slate .ui-state-error .ui-icon,
.fl-theme-slate .ui-state-error-text .ui-icon {
	background-image: url(images/ui-icons_ffffff_256x240.png);
}

/* positioning */
.fl-theme-slate .ui-icon-blank { background-position: 16px 16px; }
...
.fl-theme-slate .ui-icon-radio-on { background-position: -96px -144px; }
.fl-theme-slate .ui-icon-radio-off { background-position: -112px -144px; }
...
/* Corner radius */
.fl-theme-slate .ui-corner-all,
.fl-theme-slate .ui-corner-top,
.fl-theme-slate .ui-corner-left,
.fl-theme-slate .ui-corner-tl {
	border-top-left-radius: 5px;
}
.fl-theme-slate .ui-corner-all,
.fl-theme-slate .ui-corner-top,
.fl-theme-slate .ui-corner-right,
.fl-theme-slate .ui-corner-tr {
	border-top-right-radius: 5px;
}
.fl-theme-slate .ui-corner-all,
.fl-theme-slate .ui-corner-bottom,
.fl-theme-slate .ui-corner-left,
.fl-theme-slate .ui-corner-bl {
	border-bottom-left-radius: 5px;
}
.fl-theme-slate .ui-corner-all,
.fl-theme-slate .ui-corner-bottom,
.fl-theme-slate .ui-corner-right,
.fl-theme-slate .ui-corner-br {
	border-bottom-right-radius: 5px;
}

/* Overlays */
.fl-theme-slate .ui-widget-overlay {
	background: #cccccc url(images/ui-bg_flat_0_cccccc_40x100.png) 50% 50% repeat-x;
	opacity: .5;
	filter: Alpha(Opacity=50);
}
.fl-theme-slate .ui-widget-shadow {
	margin: -5px 0 0 -5px;
	padding: 5px;
